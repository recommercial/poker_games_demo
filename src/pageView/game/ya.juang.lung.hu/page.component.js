...
class PageComponent {
    ...
    setFeedbackInputEmpty() {
        let innDoc = this.htmlLoader.innerDocument;
        let textarea = innDoc.getElementById('GLH_feedback_content');
        textarea.value = '';
    }
...
//Panel Dom ID 
PageComponent.PANEL = {
    RECORD: 'GLH_record_panel',
    HELP: 'GLH_help_panel',
    FEEDBACK: 'GLH_feedback_panel',
    SETTING: 'GLH_setting_panel',
}

//Button Dom ID
PageComponent.BUTTON = {
    RECORD_CLOSE: 'GLH_record_cancel',
    HELP_CLOSE: 'GLH_help_cancel',
    FEEDBACK_CLOSE: 'GLH_feedback_cancel',
    FEEDBACK_OK: 'GLH_feedback_ok',
    SETTING_CLOSE: 'GLH_setting_cancel',
    SETTING_MUSIC_SWITCH: 'GLH_setting_music_switch',
    SETTING_EFFECT_SWITCH: 'GLH_setting_effect_switch',
}

PageComponent.RECORD_LIST_CONTAINER = 'GLH_record_list_container';
PageComponent.RECORD_LIST = 'GLH_record_list';
PageComponent.HELP_CONTAINER = 'GLH_help_content';

PageComponent.SETTING = {
    MUSIC: 'GLH_setting_music_value',
    EFFECT: 'GLH_setting_effect_value',
    MUSIC_BAR: 'GLH_setting_music_bar',
    EFFECT_BAR: 'GLH_setting_effect_bar',
    BAR_WIDTH: 550,
