...
import WithDrawalAuditComponent from './withdrawal_audit_component';
...
class WithdrawalMenuComponent {
    ...
    onsubmitPayment(){
        const config = {
            ...
            width: DisplaySize.RechargeFrame.width,
            height: DisplaySize.RechargeFrame.height,
            src: '/src/pageView/recharge/withdrawal_audit.html'
        }
        let component = new WithDrawalAuditComponent(config);
    }
...
export default WithdrawalMenuComponent;