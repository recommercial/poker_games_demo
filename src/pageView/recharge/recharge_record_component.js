...
import WithdrawalRecordComponent from './withdrawal_record.component';


/**
 * Making UserInfo basic.html page events and operations.
 */
class RechargeRecordComponent {
    constructor(config) {
        this._config = config || {};
    ...
    onClickWithdrawalRecord(){
        const config = {
            ...
            width: DisplaySize.RechargeFrame.width,
            height: DisplaySize.RechargeFrame.height,
            src: '/src/pageView/recharge/withdrawal_record.html'
        }
        let component = new WithdrawalRecordComponent(config);
    }
...
export default RechargeRecordComponent;